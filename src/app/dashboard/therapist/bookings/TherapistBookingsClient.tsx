...
import { Booking, Service, User, Review } from '@prisma/client'
import TherapistBookingCard from './TherapistBookingCard'
import BookingFilters from './BookingFilters'

interface TherapistBookingsClientProps {
  bookings: (Booking & {
    service: Service
    client: User
    review: Review | null
...
export default function TherapistBookingsClient({ bookings }: TherapistBookingsClientProps) {

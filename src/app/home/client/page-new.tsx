    ...
    <div className="min-h-screen bg-[#F0EBE3]">
      ...
      <section className="relative overflow-hidden pt-8 pb-16 md:pt-16 md:pb-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Greeting */}
          <div className="mb-12">
            <h1 className="text-5xl md:text-6xl font-serif text-gray-900 mb-3 leading-tight">
              {greeting}, {firstName} 🌿
            </h1>
            ...
            {clientProfile?.favorites && clientProfile.favorites.length > 0 && (
              ...
              >
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.172 2.157a1 1 0 011.656 0l1.275 2.547a1 1 0 00.928.573h2.786a1 1 0 01.59 1.805l-2.254 1.64a1 1 0 00-.364 1.118l.86 2.743a1 1 0 01-1.54 1.123l-2.25-1.64a1 1 0 00-1.176 0l-2.25 1.64a1 1 0 01-1.54-1.123l.86-2.743a1 1 0 00-.364-1.118L2.257 7.082a1 1 0 01.59-1.805h2.786a1 1 0 00.928-.573l1.275-2.547z" />
                </svg>
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="text-3xl font-serif text-[#D99A8B] mb-2">4.8⭐</div>
      ...
      {upcomingBookings.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <h2 className="text-3xl font-serif text-gray-900 mb-8">📅 Suas Próximas Sessões</h2>
      ...
      {clientProfile?.favorites && clientProfile.favorites.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <h2 className="text-3xl font-serif text-gray-900 mb-8">⭐ Seus Favoritos</h2>
      ...
      <section className="bg-white py-16 md:py-24 mb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { icon: '🔍', title: 'Explore', desc: 'Encontre terapeutas verificados em sua área' },
              { icon: '⭐', title: 'Escolha', desc: 'Veja avaliações, especialidades e disponibilidade' },
              { icon: '📅', title: 'Agende', desc: 'Reserve sessões em horários convenientes' },
              { icon: '🌟', title: 'Transforme', desc: 'Inicie sua jornada de bem-estar' }
            ].map((step, idx) => (
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="bg-gradient-to-r from-[#B2B8A3] to-[#C8963E] rounded-2xl p-12 text-white text-center">
          ...
          <Link
            href="/explore/therapists"
            className="inline-block px-8 py-3 bg-white text-[#B2B8A3] rounded-lg hover:bg-gray-100 transition-colors font-medium"
          >

...
export const therapyImages: Record<string, string> = {
  ...
  'chi-kung': 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=400&fit=crop', // Qi gong practice outdoors
  'drenagem-linfatica': 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?w=600&h=400&fit=crop', // Lymphatic massage
  'liberacao-miofascial': 'https://images.unsplash.com/photo-1598266663439-2056e6900339?w=600&h=400&fit=crop', // Foam roller therapy
  'massagem-tantrica': 'https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=600&h=400&fit=crop', // Zen massage setting
  'osteopatia': 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=600&h=400&fit=crop', // Osteopathic manipulation
  'quiropraxia': 'https://images.unsplash.com/photo-1577401239170-897942555fb3?w=600&h=400&fit=crop', // Chiropractic adjustment
  'reflexologia': 'https://images.unsplash.com/photo-1519415510236-718bdfcd89c8?w=600&h=400&fit=crop', // Foot reflexology
  'shiatsu': 'https://images.unsplash.com/photo-1552196563-55cd4e45efb3?w=600&h=400&fit=crop', // Japanese massage
  'do-in': 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=600&h=400&fit=crop', // Self-massage practice
  'feldenkrais': 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&h=400&fit=crop', // Movement awareness
  'fisioterapia-integrativa': 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&h=400&fit=crop', // Physical therapy
  'massagem-ayurvedica': 'https://images.unsplash.com/photo-1600334089648-b0d9d3028eb2?w=600&h=400&fit=crop', // Ayurvedic oil massage
  'massagem-relaxante': 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&h=400&fit=crop', // Spa relaxing massage
  ...
  'thetahealing': 'https://images.unsplash.com/photo-1474418397713-7ede21d49118?w=600&h=400&fit=crop', // Theta meditation state
  'apometria': 'https://images.unsplash.com/photo-1534330207526-8e81f10ec6fc?w=600&h=400&fit=crop', // Spiritual healing
  'cromoterapia': 'https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=600&h=400&fit=crop', // Color therapy spectrum
  'cristaloterapia': 'https://images.unsplash.com/photo-1596944924616-7b38e7cfac36?w=600&h=400&fit=crop', // Healing crystals
  'cura-pranica': 'https://images.unsplash.com/photo-1490730141103-6cac27abb37f?w=600&h=400&fit=crop', // Pranic energy healing
  ...
  'meditacao': 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&h=400&fit=crop', // Meditation practice mountain
  'coaching': 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&h=400&fit=crop', // Life coaching session
  ...
  'jornada-xamanica': 'https://images.unsplash.com/photo-1518398046578-8cca57782e17?w=600&h=400&fit=crop', // Shamanic journey
  'sound-healing': 'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=600&h=400&fit=crop', // Singing bowls
  'homeopatia': 'https://images.unsplash.com/photo-1587854692152-cbe660dbde0b?w=600&h=400&fit=crop', // Homeopathic remedies
  'terapia-floral': 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=600&h=400&fit=crop', // Bach flower remedies
...
/**
 * Retorna a URL da imagem para uma terapia específica
 * Fallback para uma imagem genérica de wellness se não encontrar
 */
export function getTherapyImage(therapyId: string): string {
  return therapyImages[therapyId] || 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=400&fit=crop'
}
